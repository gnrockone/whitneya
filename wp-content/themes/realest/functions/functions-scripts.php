...
if (!function_exists('nnp_enqueque_scripts')) {
	function nnp_enqueue_scripts() {
		...
		wp_enqueue_style('owltheme',get_template_directory_uri() . '/css/owl.theme.css', array(), '1.0.0.0', 'all');
		wp_enqueue_style('owlcarousel',get_template_directory_uri() . '/css/owl.carousel.css', array(), '1.0.0.0', 'all');
		...
		wp_enqueue_script('owl',get_template_directory_uri(). '/js/owl.carousel.js',array('jquery'),'3.3.5',true);
...
// 	function nnp_enqueue_scripts() {
// 		//css
//      wp_enqueue_style('normalize', get_template_directory_uri() . '/bower_components/normalize-css.css', array(), '1.0.0.0', 'all');
// 		wp_enqueue_style('wordpress-default', get_template_directory_uri() . '/css/wordpress-default.css', array(), '1.0.0.0', 'all');
